...
public String crearUsuario(Usuario usuario){
		...
		PreparedStatement preparedStatement = null;
		String mensaje = "Registro con exito";
		String insertUsuario = "INSERT INTO Usuario(idusuario,nombre,apellido,dni,iddistrito,vecino,titular,clave) VALUES (?,?,?,?,?,?,?,?)";
		String countDni = "SELECT COUNT (dni) FROM Usuario WHERE DNI = ?";
		

		try {
			try {
				dbConnection = (new ConnModel()).dbConnect();
				preparedStatement = dbConnection.prepareStatement(countDni);
                ...
                if (rs.next()){
                	...
                	mensaje = "Usuario ya se encuentra registrado";
        				...
        				preparedStatement.setInt(5, usuario.getIddistrito());
        				preparedStatement.setString(6, usuario.getVecino());
        				preparedStatement.setString(7, usuario.getTitular());
        				preparedStatement.setString(8, usuario.getClave());
